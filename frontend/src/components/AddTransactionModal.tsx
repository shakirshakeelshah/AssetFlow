          ...
          <div>
            ...
            <div className="flex gap-3">
              <button
                ...
                className={`flex-1 py-3 rounded-2xl font-medium ${formData.type === 'expense' ? 'bg-red-600 text-white' : 'bg-gray-100 dark:bg-gray-800'}`}
              >
                Expense
              </button>
              <button
                ...
                className={`flex-1 py-3 rounded-2xl font-medium ${formData.type === 'income' ? 'bg-green-600 text-white' : 'bg-gray-100 dark:bg-gray-800'}`}
              >
                Income
              </button>
            </div>
